    ...
    return (
        <div className="relative w-full min-h-screen bg-navy-base pt-32 pb-12">
            ...
            <main className="relative z-20 w-full max-w-4xl mx-auto flex flex-col pt-10">
                <motion.section
                    className="px-6 flex flex-col items-center pb-12 text-center relative w-full"
                ...
                <section className="px-6 space-y-6 w-full">
                    <motion.div
                        className="glass-card-3d rounded-2xl p-6 relative overflow-hidden group cursor-default isolate transform-gpu backface-hidden"
                    ...
                    <motion.div
                        className="glass-card-3d rounded-2xl p-6 relative overflow-hidden border-primary/40 group cursor-default isolate transform-gpu backface-hidden bg-gradient-to-br from-navy-base/90 to-primary/5"
                        initial={{ opacity: 0, y: 60 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                ...
                <section className="px-6 py-20 relative w-full">
                    ...
                    <button
                        ...
                        className="w-full relative group block transition-transform hover:scale-[1.01] active:scale-[0.98] cursor-pointer"
                    >
